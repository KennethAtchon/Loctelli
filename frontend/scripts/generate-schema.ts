#!/usr/bin/env tsx
/**
 * Schema Generator - Mermaid ERD Generator
 *
 * Generates a Mermaid ERD diagram from the Prisma schema.
 * This is useful for visualizing the database structure.
 *
...
function main() {
  ...
  console.log("📊 Generating Mermaid ERD from Prisma schema...");
  const mermaid = generateMermaidERD(schemaPath);

  // Output to console
  console.log("\n" + "=".repeat(80));
  console.log("MERMAID ERD DIAGRAM");
  console.log("=".repeat(80) + "\n");
  console.log(mermaid);
  console.log("\n" + "=".repeat(80));
  console.log("\n💡 Copy the diagram above and paste it into a Mermaid-compatible viewer");
  console.log("   (e.g., https://mermaid.live, GitHub, or your documentation tool)\n");
}
