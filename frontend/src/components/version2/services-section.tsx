...
export function ServicesSection() {
  ...
  return (
    <section
      id="services"
      className="py-16 px-4 bg-gray-25 relative overflow-hidden"
    >
      {/* Background Pattern */}
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">
            ...
            <span className="block text-blue-600">Needs to Dominate</span>
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Our comprehensive AI-powered suite handles every aspect of your
            marketing, from building your online presence to booking qualified
            appointments.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          {services.map((service, index) => (
            ...
            >
              {/* Gradient Overlay */}
              <div
                className={`absolute inset-0 bg-${service.gradient} opacity-0 group-hover:opacity-5 transition-opacity duration-300`}
              ></div>

              <CardHeader className="relative z-10 pb-3">
                <div
                  className={`w-12 h-12 rounded-xl bg-${service.gradient} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}
                >
        ...
        <div className="text-center">
          <div className="bg-blue-600 rounded-xl p-6 text-white">
            <h3 className="text-2xl font-bold mb-3">
              Ready to Get All Four Services?
            </h3>
            <p className="text-blue-100 mb-4">
              Book a call to see how we can transform your business with our
              complete marketing suite.
            </p>
            <Button
