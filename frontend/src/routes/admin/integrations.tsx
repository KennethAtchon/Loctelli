  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button onClick={() => toast("Integration creation not yet implemented")}>
                    ...
                    {integration ? (
                      <>
                        <Button
                          size="sm"
                          variant="outline"
                          onClick={() => toast("Integration view not yet implemented")}
                        >
                          View
                        </Button>
                        <Button
                          size="sm"
                          variant="outline"
                          onClick={() => toast("Integration editing not yet implemented")}
                        >
                      ...
                      <Button size="sm" onClick={() => toast("Integration configuration not yet implemented")}>
