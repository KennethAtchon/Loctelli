...
export const Route = createFileRoute('/admin/core/subaccounts')({
...
function AdminSubAccountsPage() {
  ...
  const handleEditSubAccount = async (id: number, data: UpdateSubAccountDto) => {
    try {
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4">
        {subAccounts.map((subAccount) => (
          <Card key={subAccount.id} className="bg-white dark:bg-slate-800 border-gray-200 dark:border-slate-700">
            <CardHeader>
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <CardDescription>{subAccount.description || "No description"}</CardDescription>
                  </div>
                </div>
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <p className="font-semibold">{subAccount._count?.users || 0}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Strategies</p>
                  <p className="font-semibold">{subAccount._count?.strategies || 0}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Leads</p>
                  <p className="font-semibold">{subAccount._count?.leads || 0}</p>
                </div>
              </div>
            </CardContent>
          </Card>
