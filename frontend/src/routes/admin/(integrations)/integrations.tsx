...
import { Plus, Edit, Trash2, CheckCircle, Zap } from "lucide-react";
...
export const Route = createFileRoute(ROUTES.ADMIN.INTEGRATIONS)({
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button
          onClick={() =>
            navigate({ to: "/admin/new", search: { template: undefined } })
          }
        >
                    ...
                    {integration ? (
                      <>
                        <Button
                          ...
                          variant="outline"
                          onClick={() =>
                            navigate({ to: `/admin/${integration.id}` })
                          }
                        >
                          View
                        </Button>
                        <Button
                          ...
                          variant="outline"
                          onClick={() =>
                            navigate({ to: `/admin/${integration.id}/edit` })
                          }
                        >
                      ...
                      <Button
                        ...
                        onClick={() =>
                          navigate({
                            to: "/admin/new",
                            search: { template: String(template.id) },
                          })
                        }
                      >
