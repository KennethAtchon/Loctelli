...
export const Route = createFileRoute('/admin/content/prompt-templates')({
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Manage AI conversation prompt templates</p>
        </div>
        <Button onClick={() => navigate({ to: '/admin/content/prompt-templates/new' })}>
              ...
              <div className="flex items-start justify-between">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    size="sm"
                    variant="outline"
                    onClick={() => navigate({ to: `/admin/content/prompt-templates/${template.id}/edit` })}
                  >
