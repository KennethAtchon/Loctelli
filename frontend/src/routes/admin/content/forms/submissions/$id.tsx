...
export const Route = createFileRoute('/admin/content/forms/submissions/$id')({
...
function FormSubmissionDetailPage() {
  ...
  const loadSubmission = async () => {
    try {
      ...
      navigate({ to: '/admin/content/forms/submissions' });
    } finally {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      toast.error(error.message || "Failed to update form submission");
    } finally {
      setLoading(false);
    }
  };
