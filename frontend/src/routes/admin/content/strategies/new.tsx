...
export const Route = createFileRoute('/admin/content/strategies/new')({
...
function NewStrategyPage() {
  ...
  const handleExportJson = () => {
    ...
    toast.success("Strategy data copied to clipboard and downloaded");
  };
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        const exampleJson = {
                          // === CORE IDENTITY ===
                          name: "Mike - Roofing Storm Damage Lead Qualifier",
                          description:
                            "Assertive sales strategy for qualifying roofing storm damage leads and booking inspections. Focuses on urgency and insurance claim assistance.",
                          tag: "roofing",
                          industryContext:
                          ...
                          aiName: "Mike",
                          aiRole:
                            "Senior Roofing Consultant with 15 years of experience specializing in storm damage assessment, insurance claims navigation, and emergency roof repairs. GAF Master Elite certified with extensive knowledge of local building codes and insurance requirements.",
                          companyBackground:
                            "We are a family-owned roofing company with 15+ years in business, GAF Master Elite Certified (top 3% of roofers nationwide), BBB A+ Rating, fully licensed and insured. We have successfully helped over 500 homeowners navigate insurance claims for storm damage repairs, with an average claim approval rate of 92%. Our team specializes in both emergency repairs and full roof replacements.",
...
8. What's your timeline for getting this addressed?`,
...
- Not the decision maker and unwilling to loop in decision maker: Schedule follow-up when decision maker is available`,
...
"I NEED TO THINK ABOUT IT": "Absolutely - this is a big decision. What specific concerns do you have? Is it the cost, the timeline, or something else? Let me address those directly so you have all the info you need."`,
...
"Just so you know, we're heading into our busy season and spots are filling up fast. I want to make sure we can get to you before the next storm hits."`,
...
- Ask if there's anything specific they want the inspector to look at`,
...
- When providing options, limit to 2-3 choices (avoid overwhelming them)`,
...
- DON'T make promises about timelines without checking crew availability`,
