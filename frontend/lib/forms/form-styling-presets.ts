...
export const STYLING_PRESETS: StylingPreset[] = [
  {
    ...
    styling: {
      ...
      card: { borderRadius: 8, shadow: "sm", height: { mobile: "400px", tablet: "600px", desktop: "700px" } },
  ...
  },
  {
    ...
    styling: {
      ...
      card: { borderRadius: 12, shadow: "md", height: { mobile: "400px", tablet: "600px", desktop: "700px" } },
  ...
  },
  {
    ...
    styling: {
      ...
      card: { borderRadius: 16, shadow: "lg", height: { mobile: "400px", tablet: "600px", desktop: "700px" } },
      buttons: { borderRadius: 8, style: "solid" },
    },
  },
];
