...
export class LeadManagementToolsVercel {
  ...
  private static readonly updateLeadDetailsSchema = z.object({
  ...
  private static readonly updateConversationStateSchema = z.object({
    qualified: z
      .boolean()
      .nullable()
      .optional()
  ...
  createUpdateLeadDetailsTool = (leadId: number) => ({
    ...
    inputSchema: LeadManagementToolsVercel.updateLeadDetailsSchema,
  ...
  createUpdateConversationStateTool = (leadId: number) => ({
    ...
    inputSchema: LeadManagementToolsVercel.updateConversationStateSchema,
