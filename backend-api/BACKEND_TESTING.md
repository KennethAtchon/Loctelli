...
**Add to your `.env` file in the `/backend-api` directory:**
```env
...
Ensure the backend is running from the `/backend-api` directory:
```bash
...
**Source:** `backend-api/src/core/app.module.ts:74-81`
