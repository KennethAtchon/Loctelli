...
@Module({
  ...
  providers: [ChatService, OpenAIPromptBuilderService, PromptHelperService, SalesBotService],
  exports: [ChatService, OpenAIPromptBuilderService, PromptHelperService, SalesBotService],
})
