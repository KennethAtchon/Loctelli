...
describe('BookingsApi', () => {
  ...
  describe('getBookings', () => {
    ...
    it('should handle get bookings error', async () => {
      ...
      await expect(bookingsApi.getBookings()).rejects.toThrow('Failed to fetch bookings')
      expect(mockGet).toHaveBeenCalledWith('/booking')
    })
  })
  ...
  describe('getBooking', () => {
    ...
    it('should handle get booking error', async () => {
      ...
      await expect(bookingsApi.getBooking(999)).rejects.toThrow('Booking not found')
  ...
  describe('createBooking', () => {
    ...
    it('should handle create booking error', async () => {
      ...
      await expect(bookingsApi.createBooking(createBookingData)).rejects.toThrow('Invalid lead')
      expect(mockPost).toHaveBeenCalledWith('/booking', createBookingData)
    })
  ...
  describe('updateBooking', () => {
    ...
    it('should handle update booking error', async () => {
      ...
      await expect(bookingsApi.updateBooking(1, updateData)).rejects.toThrow('Invalid status value')
      expect(mockPatch).toHaveBeenCalledWith('/booking/1', updateData)
    })
  })
  ...
  describe('deleteBooking', () => {
    ...
    it('should handle delete booking error', async () => {
      ...
      await expect(bookingsApi.deleteBooking(999)).rejects.toThrow('Booking not found')
  ...
  describe('getBookingsByUser', () => {
    ...
    it('should handle get bookings by user error', async () => {
      ...
      await expect(bookingsApi.getBookingsByUser(999)).rejects.toThrow('User not found')
  ...
  describe('getBookingsByLead', () => {
    ...
    it('should handle get bookings by lead error', async () => {
      ...
      await expect(bookingsApi.getBookingsByLead(999)).rejects.toThrow('Lead not found')
  ...
  describe('getBookingsByDateRange', () => {
    it('should call get bookings by date range endpoint', async () => {
      ...
      const result = await bookingsApi.getBookingsByDateRange(startDate, endDate)

      expect(mockGet).toHaveBeenCalledWith('/booking?startDate=2024-01-01&endDate=2024-01-31')
      expect(result).toEqual(mockBookings)
    })
    ...
    it('should handle get bookings by date range error', async () => {
      ...
      await expect(bookingsApi.getBookingsByDateRange(startDate, endDate)).rejects.toThrow('Invalid date range')
      expect(mockGet).toHaveBeenCalledWith('/booking?startDate=2024-01-01&endDate=2024-01-31')
    })
  })
  ...
  describe('updateBookingStatus', () => {
    ...
    it('should handle update booking status error', async () => {
      ...
      await expect(bookingsApi.updateBookingStatus(1, status)).rejects.toThrow('Invalid status value')
      expect(mockPatch).toHaveBeenCalledWith('/booking/1/status', { status })
    })
  })
