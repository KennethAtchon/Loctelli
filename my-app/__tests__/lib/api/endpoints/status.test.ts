...
describe("StatusApi", () => {
  ...
  beforeEach(() => {
    ...
    statusApi = new StatusApi(mockClient);
  });
  ...
  describe("getStatus", () => {
    ...
    it("should handle get status error", async () => {
      ...
      await expect(statusApi.getStatus()).rejects.toThrow(
  ...
  describe("getHealth", () => {
    ...
    it("should handle get health error", async () => {
      ...
      await expect(statusApi.getHealth()).rejects.toThrow(
  ...
  describe("getVersion", () => {
    ...
    it("should handle get version error", async () => {
      ...
      await expect(statusApi.getVersion()).rejects.toThrow(
