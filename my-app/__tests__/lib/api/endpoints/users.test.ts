...
describe('UsersApi', () => {
  ...
  describe('getUsers', () => {
    ...
    it('should handle get users error', async () => {
      ...
      await expect(usersApi.getUsers()).rejects.toThrow('Failed to fetch users')
      expect(mockGet).toHaveBeenCalledWith('/user')
    })
  })
  ...
  describe('createUser', () => {
    ...
    it('should handle create user error', async () => {
      ...
      await expect(usersApi.createUser(createUserData)).rejects.toThrow('Email already exists')
      expect(mockPost).toHaveBeenCalledWith('/user', createUserData)
    })
  })
  ...
  describe('updateUser', () => {
    ...
    it('should handle update user error', async () => {
      ...
      await expect(usersApi.updateUser(1, updateData)).rejects.toThrow('Invalid email format')
      expect(mockPatch).toHaveBeenCalledWith('/user/1', updateData)
    })
