...
describe("StrategiesApi", () => {
  ...
  beforeEach(() => {
    ...
    strategiesApi = new StrategiesApi(mockClient);
  });
  ...
  describe("getStrategies", () => {
    ...
    it("should handle get strategies error", async () => {
      ...
      await expect(strategiesApi.getStrategies()).rejects.toThrow(
  ...
  describe("getStrategy", () => {
    ...
    it("should handle get strategy error", async () => {
      ...
      await expect(strategiesApi.getStrategy(999)).rejects.toThrow(
        "Strategy not found"
      );
  ...
  describe("createStrategy", () => {
    ...
    it("should handle create strategy error", async () => {
      ...
      await expect(
        strategiesApi.createStrategy(createStrategyData)
      ).rejects.toThrow("Invalid prompt template");
      expect(mockPost).toHaveBeenCalledWith("/strategy", createStrategyData);
    });
  });
  ...
  describe("updateStrategy", () => {
    ...
    it("should handle update strategy error", async () => {
      ...
      await expect(strategiesApi.updateStrategy(1, updateData)).rejects.toThrow(
        "Invalid tone value"
      );
      expect(mockPatch).toHaveBeenCalledWith("/strategy/1", updateData);
    });
  ...
  describe("deleteStrategy", () => {
    ...
    it("should handle delete strategy error", async () => {
      ...
      await expect(strategiesApi.deleteStrategy(999)).rejects.toThrow(
        "Strategy not found"
      );
  ...
  describe("getStrategiesByUser", () => {
    ...
    it("should handle get strategies by user error", async () => {
      ...
      await expect(strategiesApi.getStrategiesByUser(999)).rejects.toThrow(
        "User not found"
      );
  ...
  describe("duplicateStrategy", () => {
    ...
    it("should handle duplicate strategy error", async () => {
      ...
      await expect(strategiesApi.duplicateStrategy(999)).rejects.toThrow(
        "Strategy not found"
      );
