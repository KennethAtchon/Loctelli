...
describe("PromptTemplatesApi", () => {
  ...
  beforeEach(() => {
    ...
    promptTemplatesApi = new PromptTemplatesApi(mockClient);
  });
  ...
  describe("getAll", () => {
    ...
    it("should handle get all prompt templates error", async () => {
      ...
      await expect(promptTemplatesApi.getAll()).rejects.toThrow(
  ...
  describe("getById", () => {
    ...
    it("should handle get prompt template by id error", async () => {
      ...
      await expect(promptTemplatesApi.getById(999)).rejects.toThrow(
  ...
  describe("getActive", () => {
    ...
    it("should handle get active prompt template error", async () => {
      ...
      await expect(promptTemplatesApi.getActive()).rejects.toThrow(
  ...
  describe("create", () => {
    ...
    it("should handle create prompt template error", async () => {
      ...
      await expect(promptTemplatesApi.create(createData)).rejects.toThrow(
  ...
  describe("update", () => {
    ...
    it("should handle update prompt template error", async () => {
      ...
      await expect(promptTemplatesApi.update(1, updateData)).rejects.toThrow(
  ...
  describe("activate", () => {
    it("should call activate prompt template endpoint", async () => {
      ...
      expect(mockPatch).toHaveBeenCalledWith(
        "/admin/prompt-templates/1/activate"
      );
    ...
    it("should handle activate prompt template error", async () => {
      ...
      await expect(promptTemplatesApi.activate(999)).rejects.toThrow(
        "Prompt template not found"
      );
      expect(mockPatch).toHaveBeenCalledWith(
        "/admin/prompt-templates/999/activate"
      );
    });
  });
  ...
  describe("deleteTemplate", () => {
    ...
    it("should handle delete prompt template error", async () => {
      ...
      await expect(promptTemplatesApi.deleteTemplate(999)).rejects.toThrow(
        "Prompt template not found"
      );
    ...
    it("should handle delete active prompt template error", async () => {
      ...
      await expect(promptTemplatesApi.deleteTemplate(1)).rejects.toThrow(
        "Cannot delete active prompt template"
      );
      expect(mockDelete).toHaveBeenCalledWith("/admin/prompt-templates/1");
    });
  });
