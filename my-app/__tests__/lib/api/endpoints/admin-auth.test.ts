import { AdminAuthApi, AdminLoginDto, AdminRegisterDto, AdminProfile, AdminAuthResponse, UserProfile, CreateUserDto, UpdateUserDto, DashboardStats, SystemStatus, DetailedUser, DetailedLead, UpdateAdminProfileDto, ChangeAdminPasswordDto } from '@/lib/api/endpoints/admin-auth'
...
describe('AdminAuthApi', () => {
  ...
  describe('adminLogin', () => {
    ...
    it('should handle admin login error', async () => {
      ...
      await expect(adminAuthApi.adminLogin(loginData)).rejects.toThrow('Invalid credentials')
      expect(mockPost).toHaveBeenCalledWith('/admin/auth/login', loginData)
    })
  })
  ...
  describe('adminRegister', () => {
    it('should call admin register endpoint with correct data', async () => {
      ...
      const mockResponse: Omit<AdminProfile, 'lastLoginAt' | 'createdAt' | 'updatedAt'> = {
        id: 2,
        name: 'New Admin',
        email: 'newadmin@example.com',
        role: 'ADMIN',
      ...
      expect(mockPost).toHaveBeenCalledWith('/admin/auth/register', registerData)
      expect(result).toEqual(mockResponse)
    ...
    it('should handle admin register error', async () => {
      ...
      await expect(adminAuthApi.adminRegister(registerData)).rejects.toThrow('Invalid auth code')
      expect(mockPost).toHaveBeenCalledWith('/admin/auth/register', registerData)
    })
  })
  ...
  describe('adminRefreshToken', () => {
    it('should call admin refresh token endpoint', async () => {
      ...
      expect(mockPost).toHaveBeenCalledWith('/admin/auth/refresh', { refresh_token: refreshToken })
      expect(result).toEqual(mockResponse)
      expect(result.access_token).toBeDefined()
      expect(result.refresh_token).toBeDefined()
    })
    ...
    it('should handle refresh token error', async () => {
      ...
      await expect(adminAuthApi.adminRefreshToken(refreshToken)).rejects.toThrow('Invalid refresh token')
      expect(mockPost).toHaveBeenCalledWith('/admin/auth/refresh', { refresh_token: refreshToken })
    })
  })
  ...
  describe('getAdminProfile', () => {
    ...
    it('should handle get admin profile error', async () => {
      ...
      await expect(adminAuthApi.getAdminProfile()).rejects.toThrow('Profile not found')
      expect(mockGet).toHaveBeenCalledWith('/admin/auth/profile')
    })
  })
  ...
  describe('updateAdminProfile', () => {
    ...
    it('should handle update admin profile error', async () => {
      ...
      await expect(adminAuthApi.updateAdminProfile(updateData)).rejects.toThrow('Invalid email format')
      expect(mockPut).toHaveBeenCalledWith('/admin/auth/profile', updateData)
    })
  })
  ...
  describe('changeAdminPassword', () => {
    it('should call change admin password endpoint', async () => {
      ...
      expect(mockPost).toHaveBeenCalledWith('/admin/auth/change-password', passwordData)
      expect(result).toEqual(mockResponse)
    ...
    it('should handle change password error', async () => {
      ...
      await expect(adminAuthApi.changeAdminPassword(passwordData)).rejects.toThrow('Invalid old password')
      expect(mockPost).toHaveBeenCalledWith('/admin/auth/change-password', passwordData)
    })
  })
  ...
  describe('getAllUsers', () => {
    ...
    it('should handle get all users error', async () => {
      ...
      await expect(adminAuthApi.getAllUsers()).rejects.toThrow('Failed to fetch users')
      expect(mockGet).toHaveBeenCalledWith('/admin/auth/users')
    })
  })
  ...
  describe('createUser', () => {
    it('should call create user endpoint', async () => {
      ...
      const mockResponse: Omit<UserProfile, 'lastLoginAt' | 'createdAt' | 'updatedAt' | 'createdByAdmin'> = {
        id: 3,
        name: 'New User',
        email: 'newuser@example.com',
        role: 'USER',
    ...
    it('should handle create user error', async () => {
      ...
      await expect(adminAuthApi.createUser(createData)).rejects.toThrow('Email already exists')
      expect(mockPost).toHaveBeenCalledWith('/admin/auth/users', createData)
    })
  })
  ...
  describe('updateUser', () => {
    it('should call update user endpoint', async () => {
      ...
      expect(mockPut).toHaveBeenCalledWith(`/admin/auth/users/${userId}`, updateData)
      expect(result).toEqual(mockResponse)
    ...
    it('should handle update user error', async () => {
      ...
      await expect(adminAuthApi.updateUser(userId, updateData)).rejects.toThrow('User not found')
      expect(mockPut).toHaveBeenCalledWith(`/admin/auth/users/${userId}`, updateData)
    })
  })
  ...
  describe('deleteUser', () => {
    ...
    it('should handle delete user error', async () => {
      ...
      await expect(adminAuthApi.deleteUser(userId)).rejects.toThrow('User not found')
      expect(mockDelete).toHaveBeenCalledWith(`/admin/auth/users/${userId}`)
    })
  })
  ...
  describe('generateAuthCode', () => {
    ...
    it('should handle generate auth code error', async () => {
      ...
      await expect(adminAuthApi.generateAuthCode()).rejects.toThrow('Failed to generate auth code')
      expect(mockPost).toHaveBeenCalledWith('/admin/auth/generate-auth-code')
    })
  })
  ...
  describe('getCurrentAuthCode', () => {
    ...
    it('should handle get current auth code error', async () => {
      ...
      await expect(adminAuthApi.getCurrentAuthCode()).rejects.toThrow('No auth code available')
      expect(mockGet).toHaveBeenCalledWith('/admin/auth/current-auth-code')
    })
  })
  ...
  describe('getAllAdminAccounts', () => {
      ...
      const mockAdmins: AdminProfile[] = [
        {
          ...
          role: 'SUPER_ADMIN',
          permissions: { users: 'read_write', strategies: 'read_write', admin: 'read_write' },
          isActive: true,
          lastLoginAt: '2024-01-01T12:00:00Z',
          createdAt: '2024-01-01T00:00:00Z',
          updatedAt: '2024-01-01T00:00:00Z',
    ...
    it('should handle get all admin accounts error', async () => {
      ...
      await expect(adminAuthApi.getAllAdminAccounts()).rejects.toThrow('Failed to fetch admin accounts')
      expect(mockGet).toHaveBeenCalledWith('/admin/auth/accounts')
    })
  })
  ...
  describe('deleteAdminAccount', () => {
    it('should call delete admin account endpoint', async () => {
      ...
      expect(mockDelete).toHaveBeenCalledWith(`/admin/auth/accounts/${adminId}`)
      expect(result).toEqual(mockResponse)
    ...
    it('should handle delete admin account error', async () => {
      ...
      await expect(adminAuthApi.deleteAdminAccount(adminId)).rejects.toThrow('Cannot delete super admin account')
      expect(mockDelete).toHaveBeenCalledWith(`/admin/auth/accounts/${adminId}`)
    })
  })
  ...
  describe('getDashboardStats', () => {
    ...
    it('should handle get dashboard stats error', async () => {
      ...
      await expect(adminAuthApi.getDashboardStats()).rejects.toThrow('Failed to fetch dashboard stats')
      expect(mockGet).toHaveBeenCalledWith('/general/dashboard-stats')
    })
  })
  ...
  describe('getSystemStatus', () => {
    ...
    it('should handle get system status error', async () => {
      ...
      await expect(adminAuthApi.getSystemStatus()).rejects.toThrow('Failed to fetch system status')
      expect(mockGet).toHaveBeenCalledWith('/general/system-status')
    })
  })
  ...
  describe('getRecentLeads', () => {
    ...
    it('should handle get recent leads error', async () => {
      ...
      await expect(adminAuthApi.getRecentLeads()).rejects.toThrow('Failed to fetch recent leads')
      expect(mockGet).toHaveBeenCalledWith('/general/recent-leads')
    })
  })
  ...
  describe('getDetailedUser', () => {
    ...
    it('should handle get detailed user error', async () => {
      ...
      await expect(adminAuthApi.getDetailedUser(userId)).rejects.toThrow('User not found')
      expect(mockGet).toHaveBeenCalledWith(`/general/users/${userId}/detailed`)
    })
  })
  ...
  describe('getDetailedLead', () => {
    ...
    it('should handle get detailed lead error', async () => {
      ...
      await expect(adminAuthApi.getDetailedLead(leadId)).rejects.toThrow('Lead not found')
      expect(mockGet).toHaveBeenCalledWith(`/general/leads/${leadId}/detailed`)
    })
  })
