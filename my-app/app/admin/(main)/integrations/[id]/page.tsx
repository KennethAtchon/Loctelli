            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900">{formatDate(integration.createdAt)}</p>
                </div>
              </div>
              ...
              {integration.description && (
                <div>
                  ...
                  <p className="text-sm text-gray-900 mt-1">{integration.description}</p>
                </div>
              )}
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-500">{formatDate(integration.createdAt)}</p>
                  </div>
                </div>
                ...
                {integration.lastSyncAt && (
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-500">{formatDate(integration.lastSyncAt)}</p>
                    </div>
                  </div>
                )}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-500">{formatDate(integration.updatedAt)}</p>
                  </div>
                </div>
              </div>
            </CardContent>
