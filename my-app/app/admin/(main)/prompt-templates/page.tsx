...
import { Plus, Edit, Trash2, CheckCircle, Circle, AlertCircle } from 'lucide-react';
              ...
              <div className="space-y-3">
                ...
                <div className="text-sm text-gray-600">
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    {template.maxTokens && (
                      <div>
                        <span className="font-medium">Max Tokens:</span> {template.maxTokens}
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="text-xs text-gray-500">
                  Created by {template.createdByAdmin.name} on {formatDate(template.createdAt)}
                </div>
                ...
                <div className="flex gap-2 pt-2">
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => router.push(`/admin/prompt-templates/${template.id}/edit`)}
                    className="flex-1"
                  >
