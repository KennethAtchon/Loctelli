        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div>
              ...
              <div className="flex space-x-3">
                <a href="#" className="w-8 h-8 rounded bg-gray-100 hover:bg-gray-200 flex items-center justify-center transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#services" className="text-gray-600 hover:text-gray-900 transition-colors text-sm flex items-center">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#" className="text-gray-600 hover:text-gray-900 transition-colors text-sm">Success Stories</a>
              </li>
              <li>
                <a href="#" className="text-gray-600 hover:text-gray-900 transition-colors text-sm">Case Studies</a>
              </li>
              <li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="w-full mb-4 md:mb-0">
              <div className="text-xs text-gray-500 mb-2">
                Bookings handled via Calendly. See Calendly's Privacy Policy and Terms of Use for more info.
              </div>
            ...
            <div className="flex flex-wrap justify-center md:justify-end space-x-4 text-xs">
              ...
              <a href="https://calendly.com/privacy" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700 transition-colors">Calendly Privacy Policy</a>
              <a href="https://calendly.com/terms" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700 transition-colors">Calendly Terms of Use</a>
            </div>
          </div>
        </div>
      </div>
