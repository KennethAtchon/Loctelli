      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {isMenuOpen && (
          <div className="lg:hidden border-t border-gray-100 py-3 space-y-2">
            <a href="#home" className="block text-gray-700 hover:text-purple-600 transition-colors font-medium py-2">
              Home
            </a>
            <a href="#services" className="block text-gray-700 hover:text-purple-600 transition-colors font-medium py-2">
              Services
            </a>
            <a href="#process" className="block text-gray-700 hover:text-purple-600 transition-colors font-medium py-2">
              Process
            </a>
            <a href="#contact" className="block text-gray-700 hover:text-purple-600 transition-colors font-medium py-2">
              Contact
            </a>
          </div>
        )}
