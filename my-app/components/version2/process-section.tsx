...
import { Globe, Star, Bot, Calendar, ArrowRight, Clock, CheckCircle2, Users, MessageSquare, Target } from "lucide-react";
      ...
      steps: [
        {
          ...
          description: "Schedule a 30-minute consultation to discuss your business needs and website vision.",
          duration: "30 min"
        },
        {
          title: "Mockup Presentation",
          description: "We create and show you a custom mockup of exactly what your website will look like.",
          duration: "Day 2-3"
        },
        {
          title: "Content Collection",
          description: "You approve the design and fill out our simple form with your business information.",
          duration: "Day 4"
        },
        {
          title: "Launch & Handover",
          description: "Final review call where we launch your website and train you on how to manage it.",
          duration: "Day 7"
        }
      ]
    },
      ...
      steps: [
        {
          ...
          description: "You provide your past customer database and we import it into our system.",
          duration: "Day 1"
        },
        {
          title: "SMS Campaign Launch",
          description: "Automated text messages sent to customers asking for reviews with a custom link.",
          duration: "Day 2"
        },
        {
          title: "Smart Review Filtering",
          description: "3+ stars → Google Reviews. Under 3 stars → Private feedback form (not public).",
          duration: "Automatic"
        },
        {
          title: "Ongoing Optimization",
          description: "Continuous monitoring, follow-ups, and campaign refinement for maximum results.",
          duration: "Monthly"
        }
      ]
    },
      ...
      steps: [
        {
          ...
          description: "Facebook ads launched targeting your specific areas, zip codes, and ideal customers.",
          duration: "Day 1-2"
        },
        {
          title: "Lead Capture Forms",
          description: "Interested prospects click ads and fill out forms with name, number, and email.",
          duration: "Real-time"
        },
        {
          title: "Lisa AI Qualification",
          description: "Our AI bot texts leads like a human, asks qualifying questions about their needs.",
          duration: "Instant"
        },
        {
          title: "Calendar Booking",
          description: "Qualified leads automatically scheduled for in-person estimates on your calendar.",
          duration: "24/7"
        }
      ]
    }
      ...
      <section id="process" className="py-20 px-4 bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Each service has its own streamlined process designed for maximum results. 
            Choose a service below to see exactly how we deliver.
          </p>
        </div>
                ...
                {currentProcess.steps.map((step, stepIndex) => (
                  <div key={stepIndex} className="relative">
                    ...
                    <div className="bg-white rounded-xl p-6 border-2 border-gray-200 hover:shadow-lg transition-all duration-300 group h-full">
                      {/* Step Number */}
                      <div className={`w-8 h-8 ${colors.icon} rounded-full text-white text-sm font-bold flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}>
                        {stepIndex + 1}
                      </div>
                      
                      {/* Duration Badge */}
                      <div className={`inline-block px-3 py-1 ${colors.accent} ${colors.text} text-xs font-semibold rounded-full mb-3`}>
                        {step.duration}
                      </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="text-center">
            ...
            <p className="text-gray-600">All services launched within 7 days or less</p>
          </div>
          <div className="text-center">
            ...
            <p className="text-gray-600">100% satisfaction rate with all 10+ clients</p>
          </div>
          <div className="text-center">
            ...
            <p className="text-gray-600">Ongoing optimization and support included</p>
          </div>
        </div>
